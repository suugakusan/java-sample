...
public class PythagorasServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        double c = Math.sqrt(Double.parseDouble(a)*Double.parseDouble(a) +Double.parseDouble(b)*Double.parseDouble(b));


        request.setAttribute("a", Double.parseDouble(a));
        request.setAttribute("b", Double.parseDouble(b));
